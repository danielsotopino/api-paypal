...
from paypal_api.config import get_settings
...
# Get settings from your app
settings = get_settings()

# Override the sqlalchemy.url in alembic.ini with the one from your .env
...
def include_object(object, name, type_, reflected, compare_to):
    ...
    if hasattr(object, 'schema'):
        ...
        return object.schema in ('paypal',)
    return True
